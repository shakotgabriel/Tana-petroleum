...
const Company = () => {
  return (
    <div className='bg-white py-8 filter drop-shadow-2xl'>
      <div className='container mx-auto'>
        <h1 className='text-4xl font-bold text-center mb-8'>Services</h1>
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8'>
          <div className='bg-green-50 shadow-md rounded p-4 transition-transform transform hover:scale-105 duration-300 ease-in-out'>
